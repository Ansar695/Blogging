...
export async function generateMetadata({ params }) {
    return {
      ...
      description: `Learn More about ${params.slug==="all" ? "web development" : params.slug} through our collection of expert blogs.`,
    }
  }
...
const page = ({params}) => {
  ...
  return (
    <article className="mt-12 flex flex-col text-dark">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 grid-rows-3 gap-16 mt-5 sm:mt-10 md:mt-24 px-5 sm:px-10 md:px-24 sxl:px-32">
