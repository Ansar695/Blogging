...
const Footer = () => {
  ...
  return (
    <footer className='mt-16 rounded-2xl bg-dark m-2 sm:m-10 flex flex-col items-center text-light'>
        ...
        <p className='mt-5 px-4 text-center ww-full sm:w-3/5 font-light text-sm sm:text-base'>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='mt-6 w-fit sm:min-w-[384px] flex items-stretch bg-light p-1 sm:p-2 rounded mx-4'>
            ...
            <input 
                type="submit" 
                className='bg-dark text-light pl-0 cursor-pointer font-medium rounded px-3 sm:px-5 py-1' 
            />
        </form>
        ...
        <div className='w-full mt-16 md:mt-24 relative font-medium border-t border-solid border-light py-6 px-8 flex flex-col md:flex-row items-center justify-between'>
            ...
            <div className='text-center '>
                Made with &hearts; by <a href="http://" className='underline'>CodeBucks</a>
            </div>
        </div>
    </footer>
  )
